...
@app.route('/')
def api_root():
    return 'MATCHPYRAMID IND model is already loaded\n'
...
def shutdown():
    shutdown_server()
    return 'Shutting down Matchpyramid IND flask server...\n'
...
def main(argv):
    ...
    model_file = "/home/fernando/MatchZoo/examples/robust04/config/matchpyramid_ind_ranking.config"  # args.model_file
